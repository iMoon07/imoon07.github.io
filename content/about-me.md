...
I specialize in Vulnerability Assessment & Penetration Testing (VAPT), with a focus on Web Application and API security testing.

I am also active in Vulnerability Disclosure Programs (VDP) and Bug Bounty.

**Hall of Fame / Acknowledgements:** 

List of organizations that have given recognition through their Vulnerability Disclosure Programs (VDP):
...
| **OS & Virtualization** | Windows, Linux OS Family (Debian & RHEL-based), VMware Workstation Pro |
| **Framework & Standards** | ISSAF, OWASP Top 10, CIS Benchmarks |
